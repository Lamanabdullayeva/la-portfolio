...
export const DE: Translations = {
  ...
  workContent: {
    ...
    skillGroupLabels: ['Kerntechnologien', 'UI-Bibliotheken', 'Datenvisualisierung', 'Testing', 'Tools & Plattformen', 'KI-Tools'],
    languages: [
  ...
  hobbies: {
    jewellery: {
      ...
      description: 'Ich stelle seit frühester Kindheit handgemachten Schmuck her. Jedes Stück ist einzigartig und wird mit Sorgfalt und Liebe zum Detail von Grund auf neu gefertigt. Meine Arbeiten findest du auf Instagram.',
      linkLabel:   'Galerie ansehen',
    },
    sewing: {
      name:        'Nähen',
      description: 'Nähen ist etwas, womit ich erst kürzlich angefangen habe – ich lerne noch. Ich liebe die Idee, Dinge mit meinen eigenen Händen zu erschaffen.',
    },
    community: {
      name:        'Menschen & Gemeinschaft',
      description: 'Ich verbringe gerne Zeit mit Freunden, mache gemeinsam Sport, gehe aus oder halte einfach Kontakt.\nIch engagiere mich auch bei Serve the City, wo ich ältere Menschen aus Pflegeheimen bei Spaziergängen, Bingo und anderen Aktivitäten begleite.',
    },
    sport: {
      name:        'Sport',
      description: 'Ich gehe regelmäßig zu Pilates und Yoga und versuche, mindestens einmal pro Woche ins Fitnessstudio zu gehen.',
    },
    nature: {
      name:        'Natur & Outdoor',
      description: 'Wann immer ich die Möglichkeit habe, bin ich gerne draußen in der Natur. Camping- und Trekking-Touren, Tage am See, Paddleboarding, Schnorcheln und Muscheln sammeln gehören zu meinen Lieblingsaktivitäten. Ich habe auch Surfen ausprobiert und bin noch ganz am Anfang.',
    },
    anime: {
      name:        'Bücher / Manga / Anime',
      description: 'Manchmal lese ich Manga – meistens Junji-Ito-Horror –, manchmal Sachbücher oder Romane. Früher habe ich viel über Astronomie gelesen, heute nicht mehr so oft. Ich schaue auch gerne Anime. Mein absoluter Favorit ist One Piece.',
    },
    photography: {
      name:        'Fotografie',
      description: 'Ich war auf beiden Seiten der Kamera. Ich habe eine Zeit lang als Fotomodell gearbeitet und Erfahrung als Model für Porträtfotografie gesammelt. Derzeit lerne ich auch, meine eigenen Schmuckstücke zu fotografieren.',
    },
    plants: {
      name:        'Pflanzen',
      description: 'Ich liebe es, mich um unsere Zimmer- und Gartenpflanzen zu kümmern und jeden Frühling neue zu vermehren.',
    },
  },
