...
export const EN: Translations = {
  ...
  workContent: {
    ...
    skillGroupLabels: ['Core', 'UI Libraries', 'Data Visualisation', 'Testing', 'Tools & Platforms', 'AI Tools'],
    languages: [
  ...
  hobbies: {
    ...
    nature: {
      ...
      description: 'Whenever I get the chance I love being outside in nature. Camping and trekking trips, lake days, paddle boarding, snorkelling and collecting shells are some of my favourite activities. I also tried surfing and I am still very much a beginner.',
    },
    anime: {
    ...
    plants: {
      name:        'Plants',
      description: 'I love taking care of our indoor and outdoor plants and propagating new ones almost every spring.',
    },
  },
